...
--   id NUMBER(4) GENERATED ALWAYS AS IDENTITY (START WITH 101) NOT NULL PRIMARY KEY,
...
-- GRANT ALL ON products to inventoryuser;
...
CREATE TABLE inventoryuser.products_on_hand (
  product_id NUMBER(4) NOT NULL PRIMARY KEY,
  quantity NUMBER(4) NOT NULL,
  FOREIGN KEY (product_id) REFERENCES products(id)
);
-- GRANT ALL ON products_on_hand to inventoryuser;
...
CREATE TABLE inventoryuser.orders (
...
-- GRANT ALL ON orders to inventoryuser;
